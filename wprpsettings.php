...
if(isset($_POST['saveChanges'])) {
	...
	$rp_email_address=isset($_POST['rp_email_address'])?$_POST['rp_email_address']:get_site_option('admin_email');
	...
	$update_query[]=update_site_option("rp_send_email",$rp_send_email);
	$update_query[]=update_site_option("rp_email_address",$rp_email_address);
	$update_query[]=update_site_option("rp_display_text",$rp_display_text);
	$update_query[]=update_site_option("rp_thanks_msg",$rp_thanks_msg);
	$update_query[]=update_site_option("rp_options",$report_options);
	$update_query[]=update_site_option("rp_if",$report_if);
	
	$update_query[]=update_site_option("rp_registeronly",$rp_registeronly);
	$update_query[]=update_site_option("rp_page",$rp_page);
	$update_query[]=update_site_option("rp_categories",$rp_categories);
...
### Needed Variables
$rp_send_email=intval(get_site_option("rp_send_email"));
$rp_email_address=get_site_option("rp_email_address");
$rp_display_text=get_site_option("rp_display_text");
$rp_thanks_msg=get_site_option("rp_thanks_msg");
$report_options=get_site_option("rp_options");
$report_if=(int)get_site_option("rp_if");

$rp_registeronly=(int)get_site_option("rp_registeronly");
$rp_page=(int)get_site_option("rp_page");
$rp_categories=get_site_option("rp_categories");
...
if(isset($_POST['upgrade']))
{
	...
	update_site_option("rp_send_email", $email_opt);
